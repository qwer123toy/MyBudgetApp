# 💝 MyBudgetApp - 귀여운 가계부 앱

> 개발자: 이지맨 | 버전: 1.0.2

## 📱 앱 소개

MyBudgetApp은 **귀여운 디자인**과 **강력한 기능**을 결합한 Android 가계부 앱입니다. 
...
1. **APK 다운로드**: [Releases](../../releases)에서 최신 APK 다운로드
2. **개발자 옵션 활성화**: 설정 > 개발자 옵션 > 알 수 없는 소스 허용
3. **APK 설치**: 다운로드된 APK 파일 실행하여 설치
